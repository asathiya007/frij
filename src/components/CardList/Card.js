...
import banana from "../../assets/apple.png";
import pear from "../../assets/apple.png";
import egg from "../../assets/apple.png";
...
const Card = ({ name, expDate, price}) => {
    ...
    return (
        <article class="br3 ba dark-gray b--black-10 mv4 w-100 w-50-m w-25-l mw5 center bg-white">
            <img src={image} height="200px" weight="200px" class="db w-100 br2 br--top" alt="food"/>
